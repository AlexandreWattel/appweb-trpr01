...
import { ajouterProduit } from "../script/produit/produit";
...
import { produitUtiliser } from "../script/form/formState";
...
const essayeAjouterProduit = () => {
  if (validateForm()) {
    ajouterProduit(produitUtiliser.value);
...
<template>
  <div class="container mt-5">
    <div class="card shadow rounded-4 p-4">
      ...
      <form @submit.prevent="essayeAjouterProduit">
        <!-- Nom -->
        <div class="mb-3">
        ...
        <!-- Bouton d'ajout -->
        <div class="text-end">
          <button type="submit" class="btn bg-info-subtle rounded-4 px-4">
            Ajouter
          </button>
        </div>
      </form>
